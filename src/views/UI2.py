...
class LoginWindow(QWidget):
    ...
    def labels(self):
        ...
        pass_label.setStyleSheet("""color:#868179""")
         # Mensaje de errror
        errorinicio_label = QLabel('Ingrese un Usuario/Correo o contraseña valido', self)
        errorinicio_label.setFont(QFont('Now', 18))
        font = errorinicio_label.font()
        font.setBold(True)
        font.setHintingPreference(QFont.HintingPreference.PreferNoHinting)
        errorinicio_label.setFont(font)
        errorinicio_label.move(1040,700)
        errorinicio_label.setStyleSheet("""color:#868179""")
        errorinicio_label.hide()
...
class SignUpWindow(QWidget):
    ...
    def SignUp_clicked(self): # se requiere mostrar un mensaje de diciendo que el usuario ya existe o que se requieren campos llenos
...
class UserWindow(QWidget):
    ...
    def addShelve_clicked(self, list: list = None):
        ...
        #
        book1 = QGroupBox('')
        self.config_BookBox(book1, list[0])
        book2 = QGroupBox('')
        self.config_BookBox(book2, list[1])
        book3 = QGroupBox('')
        self.config_BookBox(book3, list[2])
        book4 = QGroupBox('')
        self.config_BookBox(book4, list[3])
        #############################################
    ...
    def init_books(self):
        ...
        chell = []
        for libro in libros:
            chell.append(libro['nombre'])
        '''for i in range(0, len(libros), 4):
            chell.append(libros[i:i+4])
        for i in chell:
            self.addShelve_clicked(i)'''
        self.addShelve_clicked(chell)
